...
if (foraLimit()) {
	$ok = "S'HA TANCAT EL PLAÇ PER A FER CANVIS AQUESTA JORNADA!!!";
}
...
if ($ok != "nada") {
	if ($ok == "ALINEACIO GUARDADA CORRECTAMENT") 
		echo "<font color=\"#006600\" size=\"3\"><b>" . $ok . "</b></font>";
	else
		echo "<font color=\"#FF0000\" size=\"3\"><b>" . $ok . "</b></font>";
}
 ?>
...
?>
	...
	?>
		...
		<br><tr><td colspan="5"><div align="center"><input type="submit" value="Guardar"></div></td></tr><br>
<?php
	}
	else
